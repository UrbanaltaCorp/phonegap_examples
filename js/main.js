var app = {
    ...
    registerEvents: function() {
        ...
        if (document.documentElement.hasOwnProperty('ontouchstart')) {
            // ... if yes: register touch event listener to change the
    ...
    slidePage: function(page) {
        ...
        setTimeout(function() {
            // Slide out the current page: If new page slides from the
            // right -> slide current page to the left, and vice versa
